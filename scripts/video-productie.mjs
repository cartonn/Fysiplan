...
function buildManifest(previous) {
  ...
  return {
    ...
    language: "nl-NL",
    avatar: {
      platform: "Unreal Engine MetaHuman",
      profile: "Fysiplan MetaHuman v1 — fotorealistisch, volwassen, neutrale en professionele uitstraling",
      bodyMotionSource: "motion capture van een BIG-geregistreerde of aantoonbaar bevoegde fysiotherapeut",
      facialAnimationSource: "MetaHuman Audio Driven Animation op de goedgekeurde Nederlandse voice-over",
      rule: "Nooit lichaamsbeweging uit tekst-naar-video genereren.",
    },
    render: {
